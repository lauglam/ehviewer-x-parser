...
// Use it for homepage
const NONE: i8 = -1;
const UNKNOWN: usize = 0x400;

const ALL_CATEGORY: usize = UNKNOWN - 1;

// DOUJINSHI|MANGA|ARTIST_CG|GAME_CG|WESTERN|NON_H|IMAGE_SET|COSPLAY|ASIAN_PORN|MISC;

const BG_COLOR_DOUJINSHI: usize = 0xfff44336;
const BG_COLOR_MANGA: usize = 0xffff9800;
const BG_COLOR_ARTIST_CG: usize = 0xfffbc02d;
const BG_COLOR_GAME_CG: usize = 0xff4caf50;
const BG_COLOR_WESTERN: usize = 0xff8bc34a;
const BG_COLOR_NON_H: usize = 0xff2196f3;
const BG_COLOR_IMAGE_SET: usize = 0xff3f51b5;
const BG_COLOR_COSPLAY: usize = 0xff9c27b0;
const BG_COLOR_ASIAN_PORN: usize = 0xff9575cd;
const BG_COLOR_MISC: usize = 0xfff06292;
const BG_COLOR_UNKNOWN: usize = 0x00000000;
...
const CATEGORY_VALUES: [usize; 11] = [
    eh_config::MISC,
    eh_config::DOUJINSHI,
    eh_config::MANGA,
    eh_config::ARTIST_CG,
